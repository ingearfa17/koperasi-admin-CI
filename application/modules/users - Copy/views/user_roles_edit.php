...
<form id="frm_edit_role" enctype="multipart/form-data" role="form">
  <div class="modal-header">
      <h4 class="modal-title" id="mdl_roleLabel">Update Data Roles</h4>
  </div>
  <div class="modal-body">
      ...
      <div class="modal-footer">
          <button type="submit" style="margin-top: 5px" class="btn btn-success btn-sm"><i class="fa fa-save"></i> Update</button>
          <button type="button" onclick="$('#list_continer').show('slow'); $('#edit_role_container').hide('slow')" class="btn btn-danger btn-sm" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
      </div>
      ...
      <!-- modal add role end -->
       <script>
            $('#frm_edit_role').submit(function(e) {
                var form = $(this);
                var formdata = false;
                if(window.FormData){
