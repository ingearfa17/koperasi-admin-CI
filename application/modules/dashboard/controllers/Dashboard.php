...
/*				if($dt_stat['status_kantor']!='FALSE'){
				...
				$lbl_array[] =$dt_stat['status_kantor'];
	...
	public function view_data(){
		$data_status_koperasi = $this->Dashboard_model->get_statistic_status_koperasi();
		$array_title = array('Status', 'Jumlah');
		$table = generate_table($array_title, $data_status_koperasi,'');
		echo $table;
	}

	public function data_kelembagaan(){
		$data_src = $this->Dashboard_model->get_data_kelembagaan();
		$array_title = array('Nama Koperasi', 'Badan Hukum', 'Status', 'Rapat Anggota', 'Jml. Anggota', 'Tgl. Kunjungan' );
		$table = generate_table($array_title, $data_src,'');
		$data=array('title' =>'Data Kunjungan Kelembagaan',
						'isi' => 'dashboard/container_tbl',
						'root'=> $this->menu,
						'chart'=> $table
	...
	public function data_pengurus(){
		$data_src = $this->Dashboard_model->get_data_pengurus();
		$array_title = array('Nama Koperasi', 'Badan Hukum', 'Nama Pengurus', 'Jabatan','No. Tlp', 'Alamat', 'Tgl. Kunjungan' );
		$table = generate_table($array_title, $data_src,'');
		$data=array('title' =>'Data Kunjungan (Pengurus)',
						'isi' => 'dashboard/container_tbl',
						'root'=> $this->menu,
						'chart'=> $table
	...
	public function data_pengawas(){
		$data_src = $this->Dashboard_model->get_data_pengawas();
		$array_title = array('Nama Koperasi', 'Badan Hukum', 'Nama Anggota', 'Jabatan','No. Tlp', 'Alamat', 'Tgl. Kunjungan' );
		$table = generate_table($array_title, $data_src,'');
		$data=array('title' =>'Data Kunjungan (Pengawas)',
						'isi' => 'dashboard/container_tbl',
						'root'=> $this->menu,
						'chart'=> $table
	...
	public function data_perkembangan(){
		$data_src = $this->Dashboard_model->get_data_perkembangan();
		$array_title = array('Nama Koperasi', 'Badan Hukum', 'Jml. Anggota (A)', 'Jml. Anggota (B)','SHU (A)', 'SHU (B)', 'Simp. Pokok (A)', 'Simp. Pokok (B)', 'Tgl. Kunjungan');
		$table = generate_table($array_title, $data_src,'', array(3,4,5,6,7));
		$data=array('title' =>'Data Kunjungan (Perkembangan Koperasi)',
						'isi' => 'dashboard/container_tbl',
						'root'=> $this->menu,
						'chart'=> $table
	...
	public function data_temuan(){
		$data_src = $this->Dashboard_model->get_data_temuan();
		$array_title = array('Kode Koperasi','Nama Koperasi', 'Badan Hukum',  'Alamat','Status Kantor', 'Kegiatan Usaha', 'Nama Pengelola', 'No. Tlp', 'Jml. Anggota', 'Sebaran Anggota', 'Tgl. Kunjungan' );
		$table = generate_table($array_title, $data_src,'');
		$data=array('title' =>'Data Kunjungan (Temuan Koperasi)',
						'isi' => 'dashboard/container_tbl',
						'root'=> $this->menu,
						'chart'=> $table
	...
	public function view_chart(){
		$data_status_koperasi = $this->Dashboard_model->get_statistic_status_koperasi();
			...
			$data['chart']= $chart_status_kop=generate_chart('bar', $lbl_array, $dt_array,2);		
			echo $this->load->view('dashboard/container_chart',$data);
	}


public function chart_jumlah_anggota(){
    	$id_kecamatan = $this->input->post('the_id');
		...
		/*$data=array('isi'=>'container_chart',
						'content'=>$chart_anggota,
						'dt_cbo_kec'=>$dt_cbo_kec,
						'link'=>'chart_jumlah_anggota'
					);*/
