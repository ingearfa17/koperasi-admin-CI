                    ...
                    <div class="navbar-container ace-save-state" id="navbar-container">
                        ...
                        <div class="navbar-header pull-left">
                            <a href="index.html" class="navbar-brand">
                                <small>
                                    <img style="height: 25px" src="<?php echo base_url()?>assets/images/logodepok.gif">
                                    <!-- <i class="fa fa-leaf"></i> -->
                                    Sistem Informasi Pokja Koperasi
                                </small>
                            </a>
                          <span class="loading" style="display: none; left: 50%;top: -20%;">
                                  <img src="<?php echo base_url().'assets/images/loadingbar.gif'; ?>"/>
                          </span>
                        </div>
