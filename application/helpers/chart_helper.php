...
function generate_chart($chartType, $lbl_array, $dt_array, $color_index){
    
    $data = $dt_array ;
    $labels = $lbl_array;
    $colors = array(
              array('backgroundColor' => 'rgba(44, 181, 78, 0.08)', 'borderColor' => '#5fced8'),
    ...
    $attributes = array('id' => 'example', 'width' => 100, 'height' => 50, 'style' => 'display:inline; padding-left:5px');

    $datasets = array(
                    array('data' => $data, 'label' =>'Jumlah')+$colors[$color_index] ,
...
function group_bar_chart($dt_array, $lbl_array, $arr_dataset, $showYaxes =true, $yaxeslabel='', $displayLegend=true, $legendPos="bottom", $legendLabel='',$chartTitle='', $titlePos='top' ){
    $data = $dt_array;
    $labels = $lbl_array;

    //html attributes fot the canvas element
    $attributes = array('id' => 'example', 'width' => 500,  'height' => 400, 'style' => 'display:inline;');
